 ...
 * Legacy Backup
 *
 * Camera UX Refactoring 이전 버전
 */
export class CameraController_backup {
  ...
  private readonly defaultWheelSpeed = 148; //100 -> 148
  ...
  // 기존 speed=150일 때의 wheelPrecision
  private readonly legacyMinWheelPrecision = 0.2;

  // 새 speed=200일 때의 wheelPrecision
